...
@section('title', 'Modifier le budget')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Modifier le budget: {{ $budget->nom }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('user.budgets.update', $budget->id) }}" method="POST">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control @error('nom') is-invalid @enderror" id="nom" name="nom" value="{{ old('nom', $budget->nom) }}" required>
                                @error('nom')
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control @error('date_debut') is-invalid @enderror" id="date_debut" name="date_debut" value="{{ old('date_debut', $budget->date_debut) }}" required>
                                @error('date_debut')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control @error('date_fin') is-invalid @enderror" id="date_fin" name="date_fin" value="{{ old('date_fin', $budget->date_fin) }}" required>
                                @error('date_fin')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form-control @error('montant_total') is-invalid @enderror" id="montant_total" name="montant_total" value="{{ old('montant_total', $budget->montant_total) }}" required>
                        ...
                        <div id="categories-container">
                            ...
                            <div class="form-group row mb-3 categorie-row" data-id="{{ $categorie->id }}">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input type="number" min="0" max="100" class="form-control pourcentage-input" name="categories[{{ $categorie->id }}][pourcentage]" value="{{ $categorieBudgets[$categorie->id]->pourcentage ?? $categorie->pourcentage_defaut }}" required>
                                        <div class="input-group-append">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input type="number" step="0.01" class="form-control montant-input" name="categories[{{ $categorie->id }}][montant]" value="{{ $categorieBudgets[$categorie->id]->montant_alloue ?? 0 }}" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text">MAD</span>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 text-center">
                                ...
                                <a href="{{ route('user.budgets.show', $budget->id) }}" class="btn btn-secondary">
